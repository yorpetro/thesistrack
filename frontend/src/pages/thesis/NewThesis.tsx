    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border dark:border-gray-700">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New Thesis</h1>
        </div>

        {error && (
          <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-300 rounded-md">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="title" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Thesis Title <span className="text-red-500 dark:text-red-400">*</span>
            </label>
            <input
              type="text"
              id="title"
          ...
          <div>
            <label htmlFor="abstract" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Abstract
            </label>
            <textarea
              id="abstract"
