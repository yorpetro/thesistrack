...
const SetDeadlines: React.FC = () => {
  ...
  const getTypeColor = (type: DeadlineType) => {
    switch (type) {
      case 'submission': return 'bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300';
      case 'review': return 'bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300';
      case 'defense': return 'bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300';
      case 'revision': return 'bg-orange-100 dark:bg-orange-900/20 text-orange-800 dark:text-orange-300';
      default: return 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-300';
    }
  };

  if (loading) {
    return <div className="flex justify-center p-8 text-gray-600 dark:text-gray-400">Loading deadlines...</div>;
  }

  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-gray-100">Manage Thesis Deadlines</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8 border dark:border-gray-700">
        <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Set Defense Deadline</h2>
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4 mb-4">
          <div className="flex">
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800 dark:text-blue-300">Automatic Deadline Creation</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="deadline_date" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Defense Date & Time *
            </label>
            <input
              type="datetime-local"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Existing Deadlines</h2>
        </div>
              ...
              <div key={deadline.id} className="p-6 flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{deadline.title}</h3>
                  ...
                  {deadline.description && (
                    <p className="text-gray-600 dark:text-gray-300 text-sm">{deadline.description}</p>
                  )}
                </div>
                
                <button
                  onClick={() => handleDelete(deadline.id)}
                  className="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 ml-4 transition-colors duration-200"
